...
<form method="post" action="?action=details" role="form" data-toggle="validator">
    ...
    <div class="row">
        ...
        <div class="col-sm-6 col-xs-12 pull-right">
            ...
            <div class="form-group">
                ...
                <input type="tel" name="phonenumber" id="inputPhone" value="{$clientphonenumber}"{if in_array('phonenumber',$uneditablefields)} disabled=""{/if} class="form-control" pattern='^[\+]\d&#123;2&#125;[\.]\d&#123;10&#125;$' />
                <div class="help-block with-errors"></div>
                <p class="help-block">Εισάγετε το τηλέφωνό σας σε μορφή +30.69ΧΧΧΧΧΧΧΧ</p>
            </div>
