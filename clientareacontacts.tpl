{if $contactid}
    ...
    <form role="form" method="post" action="{$smarty.server.PHP_SELF}?action=contacts&id={$contactid}" data-toggle="validator">
        ...
        <div class="row">
            <div class="col-sm-6">
                ...
                <div class="form-group">
                    ...
                    <input type="tel" name="phonenumber" id="inputPhone" value="{$contactphonenumber}" class="form-control" pattern='^[\+]\d&#123;2&#125;[\.]\d&#123;10&#125;$' />
                    <div class="help-block with-errors"></div>
